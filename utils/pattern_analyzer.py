      ...
      return {
          'sql_injection': {
              ...
              'legitimate_indicators': [
                  ...
                  r"sql\s+query", r"database\s+example", r"api\s+documentation"
              ],
              'severity': 'high'
          },
          'xss': {
              ...
              'legitimate_indicators': [
                  ...
                  r"javascript\s+code", r"html\s+snippet", r"script\s+tag\s+example"
              ],
              'severity': 'high'
          },
          'command_injection': {
              ...
              'legitimate_indicators': [
                  r"<code>", r"<pre>", r"example", r"command\s+line\s+tutorial",
                  r"shell\s+script", r"terminal\s+command"
              ],
              'severity': 'critical'
          },
          'path_traversal': {
              ...
              'legitimate_indicators': [
                  r"<code>", r"<pre>", r"example", r"path\s+explanation",
                  r"file\s+system\s+navigation", r"directory\s+structure"
              ],
              'severity': 'medium'
          }
      }
